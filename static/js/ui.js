...
const loadingMessages = [
    "Orquestrando fluxo de trabalho com colunas computadas...",
    "Analisando consulta para seleção ideal de ferramentas (chamada LLM)...",
    "Aplicando UDFs para processamento personalizado de dados...",
    "Consultando índices de embeddings para contexto semântico...",
    "Transformando dados dinamicamente para contexto...",
    "Buscando trechos relevantes de documentos usando iteradores...",
    "Acessando tabelas para contexto do histórico de chat...",
    "Recuperando itens salvos do banco de memória...",
    "Chamando APIs externas via funções declarativas...",
    "Extraindo frames/áudio com colunas computadas...",
    "Compilando contexto de múltiplas fontes de dados...",
    "Gerenciando dependências de execução declarativamente...",
    "Gerando resposta final usando LLM e contexto...",
    "Armazena referências de dados multimodais eficientemente...",
    "Armazenando resultados intermediários em cache para velocidade...",
    "Garantindo consistência de dados durante operações..."
];
...
const imageGenLoadingMessages = [
    "Preparando tarefa de geração de imagem...",
    "Disparando API de geração de imagem via coluna computada...",
    "Aguardando resposta da API DALL-E 3...",
    "Armazenando referência da imagem gerada na tabela...",
    "Vinculando imagem gerada ao prompt no histórico...",
    "Gerenciando chamadas de API declarativamente..."
];
...
function updateUIForAuthState(isAuthenticated) {
    ...
    if (queryInput) {
        if (!isAuthenticated) {
            queryInput.placeholder = "Faça login ou cadastre-se para começar a conversar..."; // Updated placeholder
        } else {
            queryInput.placeholder = "Digite sua pergunta aqui...";
        }
    }
        ...
        tableHtml += `
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Pergunta</th>
                    <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Resposta</th>
...
function updateHistoryPaginationInfo(startIndex, endIndex, totalEntries) {
    ...
    if (paginationInfo) {
        paginationInfo.innerHTML = `Mostrando ${totalEntries > 0 ? startIndex + 1 : 0}-${endIndex} de ${totalEntries} entradas`;
    }
}
