...
if os.environ.get('FORCE_CPU', 'True').lower() == 'true':
...
from pixeltable.iterators import FrameIterator, AudioSplitter
...
# Create a table for tabular data files (CSV, Excel).
tabular = pxt.create_table(
    "agents.tabular",
    {"tabular": pxt.String, "uuid": pxt.String, "timestamp": pxt.Timestamp, "user_id": pxt.String},
    if_exists="ignore",
)
print("Created/Loaded 'agents.tabular' table")
